...
from accounts.utils.mfa_notify import notify_user
...
class ManagerEmployerProfileManageViewSet(viewsets.ViewSet):
...
class ManagerEmployeeProfileManageViewSet(viewsets.ViewSet):
    permission_classes = [IsAuthenticated, IsManagerOnly]
